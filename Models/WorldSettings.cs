...
public class WorldSettings
{
    ...
    // Шанс в год, что община, отрезанная расстоянием от единоверцев, породит свой толк (см. SchismSystem)
    public double SchismChance { get; set; } = 0.03;



    // Восстания

    // Сколько лет поселение остаётся в открытом неповиновении короне (см. RebellionSystem)
    public int RebellionDuration { get; set; } = 8;
