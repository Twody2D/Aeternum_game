...
public class Settlement
{
    ...
    public int RebellingUntilYear { get; set; } // Год, до которого поселение в открытом неповиновении короне (0 — не восставало), см. RebellionSystem
    public Kingdom? RebellingAgainst { get; set; } // Против кого восстало: выпав из Kingdom.Settlements, поселение иначе стало бы короне невидимым
    ...
    public Language? Language { get; set; } // Наречие, на котором здесь говорят — может смениться от долгой торговли (см. LanguageSystem)
