...
public static class YearProcessor
{
    public static void Process(World world)
    {
        ...
        // 15. Миграция из голодающих поселений
        MigrationSystem.Process(world);

        // 16. Колонизация: переполненные поселения основывают новые
        ColonizationSystem.Process(world);

        // 17. Государства: обновление контроля территорий, престолонаследие, новые королевства
        KingdomSystem.Process(world);

        // 18. Союзы между государствами
        AllianceSystem.Process(world);

        // 19. Войны за спорные поселения между государствами
        WarSystem.Process(world);

        // 20. Заговоры против правителя
